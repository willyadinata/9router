// Branch-local identity for the 9router-plus build.
//
...
// Data directory name. Hidden on unix (~/.9router-plus) and plain under %APPDATA% on
// Windows, mirroring the upstream convention, so this branch never touches ~/.9router.
export const APP_DIR_NAME = "9router-plus";
